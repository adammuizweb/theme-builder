...
if (!$zipPath) { echo json_encode(['error' => 'Build failed.']); exit; }
...
echo json_encode(['success' => true, 'zip_size' => filesize($zipPath), 'download_url' => $baseUrl . $adminPath . '/?action=api&page=admin/tools/theme-builder/api/download_zip&theme=' . rawurlencode($slug)]);
exit;
